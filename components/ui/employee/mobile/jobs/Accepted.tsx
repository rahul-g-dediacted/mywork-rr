    ...
    <div className="w-full">
      <div className=" w-11/12 mx-auto">
        ...
        <div className="flex flex-col mt-10 ">
          <div className="w-full bg-white flex flex-col p-4 border-b my-2 hover:bg-primary-100">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex">
                <Link
                  to="/ee/applyjob"
                  className="font-semibold bg-gradient-to-r from-primary-400 to-primary-500 hover:to-primary-400 text-white text-sm  py-2 ml-2 px-4 rounded cursor-pointer"
                >
                  Message
                </Link>
              </div>
