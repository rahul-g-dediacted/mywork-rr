    ...
    >
      <div className="flex flex-row justify-between pt-10 w-full">
        <Image
          ...
          src={Logo}
          alt="myWork"
          className="block text-white ml-6 w-32"
        />
        <Image
          src={ProfilePic}
          alt="Profile Pic"
      ...
      <div className="nav_links flex flex-col items-start justify-center mt-16 w-full">
        <Link
          ...
          <h1 id="hide_side1" className="block text-inherit text-xl pl-3">
            Profile
          </h1>
        </Link>
        <Link
        ...
        >
          ...
          <h1 id="hide_side1" className="text-inherit text-xl pl-3 block">
            Jobs
          </h1>
        </Link>
        <Link
