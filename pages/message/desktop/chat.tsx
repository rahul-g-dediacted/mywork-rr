import Photo from "../../../public/assets/imgs/profile.jpg";
    ...
    <div className="flex-1 ">
      <div className="flex flex-col h-screen  justify-between relative">
        <div className="flex flex-col">
          <div className="w-full bg-primary-500 h-[13vh] z-20">
        ...
        <div className="flex bg-white w-full items-center shadow h-[11vh] justify-center px-2 relative">
          <div
            id="attach_menu"
            className="absolute 'hidden' left-4 shadow rounded bottom-[86px] bg-white 'flex' flex-col p-2 hidden"
          >
